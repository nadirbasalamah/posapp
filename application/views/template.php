		...
		<div class="container">
			...
			<?php if ($this->session->userdata('akses') == 2) { ?>
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
                        <a class="nav-link" href="<?=base_url();?>page/lihat_laporan/<?php $time = mktime(0, 0, 0, date('m')-1, date('d'), date('Y')); echo date('Y-m-d', $time);?>/<?=date('Y-m-d');?>/">Laporan</a>
					</li>
					<li class="nav-item">
			...
			<?php } else if ($this->session->userdata('akses') == 1) { ?>
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="themes">Barang <span class="caret"></span></a>
						<div class="dropdown-menu" aria-labelledby="themes">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="themes">Pengaturan <span class="caret"></span></a>
						<div class="dropdown-menu" aria-labelledby="themes">
		...
		<footer id="footer">
			<div class="row">
        		<div class="col-lg-12">
					...
					<small><p align="right">&copy; <?=date('Y');?> - <?=$this->fungsi->aplikasi()['nm_app'];?> v.1.0 | Dibuat oleh <a href="https://www.bablog.us" target="_blank">Bablog.us</a></p></small>
				</div>
			</div>
		</footer>
	</div>
